...
parser.add_argument('--trainpath', type= str, default = '../../../data/jordanlei/coco/images/test2017')
parser.add_argument('--annpath', type= str, default = '../../../data/jordanlei/coco/annotations/instances_test2017.json')
